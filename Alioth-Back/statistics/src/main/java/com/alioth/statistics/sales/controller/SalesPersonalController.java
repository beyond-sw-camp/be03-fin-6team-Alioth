...
public class SalesPersonalController {

    @GetMapping("/api/stat/sales/personal/day")
    ...
    @GetMapping("/api/stat/sales/personal/month")
    ...
    @GetMapping("/api/stat/sales/personal/year")
